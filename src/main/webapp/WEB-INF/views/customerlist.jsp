			...
			<div >
				<ul class="navbar-nav mr-auto">
					<li class="nav-item" ><a class="nav-link" href="<%=request.getContextPath()%>/Home"
						>Home</a></li>
					<li class="nav-item active"><a class="nav-link" href="<%=request.getContextPath()%>/CustomerGetAll"
						>Customers</a></li>
	...
	<div class="row">
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/CustomerAdd" class="btn btn-success">Add
					New Customer</a>
				...
				<tbody>
					<c:forEach var="customer" items="${listCustomer}">
						...
						<tr>
							...
							<td><c:out value="${customer.cnic}" /></td>
							<td><c:out value="${customer.cphone}" /></td>
							<td><c:out value="${customer.caddress}" /></td>
							<td><a href="/EasyRent_Management/CustomerEdit?id=<c:out value='${customer.cid}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="/EasyRent_Management/CustomerDelete?id=<c:out value='${customer.cid}' />">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
